...
/**
 * Immutable class that keeps track of the running status of
 * a {@link RebalancePartitionsInfo} instance.
 * 
 * @author jocohen
 * @since Jan 14, 2011
 */
public class RebalancePartitionsInfoLiveCycle {
    ...
    public RebalancePartitionsInfoLiveCycle(final RebalancePartitionsInfo pinfo, final RebalancePartitionsInfoLifeCycleStatus status) {
