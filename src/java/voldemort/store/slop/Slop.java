...
public class Slop {
    ...
    public boolean equals(Object obj) {
        ...
        return operation == slop.getOperation() && Objects.equal(storeName, getStoreName())
               ...
               && Utils.deepEquals(transforms, slop.getTransforms())
               && getNodeId() == slop.getNodeId() && Objects.equal(arrived, slop.getArrived());
    }

    @Override
    public int hashCode() {
        return Objects.hashCode(storeName, operation, getNodeId(), arrived) + key.hashCode()
    ...
    public String toString() {
        return "Slop(storeName = " + storeName + ", operation = " + operation + ", key = " + key
               + ", value = " + value + ", nodeId = " + getNodeId() + ", arrived" + arrived + ")";
    }
