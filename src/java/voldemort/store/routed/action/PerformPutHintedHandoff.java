...
public class PerformPutHintedHandoff extends AbstractHintedHandoffAction<Version, PutPipelineData> {
    ...
    public PerformPutHintedHandoff(PutPipelineData pipelineData,
                                   ...
                                   byte[] transforms,
                                   HintedHandoffStore hintedHandoff,
                                   Time time) {
    ...
    public void execute(Pipeline pipeline) {
        ...
        for(Node failedNode: failedNodes) {
            ...
            hintedHandoff.storeSlop(failedNode, visited, slop, version);
        }
