...
public class IncrementClock extends AbstractAction<ByteArray, Version, PutPipelineData> {
    ...
    public void execute(Pipeline pipeline) {
        ...
        versionedClock.incrementClock(pipelineData.getMaster().getId(), time.getMilliseconds());
