...
public class ReadRepairerTest extends TestCase {
    ...
    public void testAllEqual() throws Exception {
        ...
        values.add(toValue(2, 1, getClock(1)));
        values.add(toValue(3, 1, getClock(1)));
    ...
    public void testNoDuplicates() throws Exception {
        List<NodeValue<Integer, String, Integer>> values = Lists.newArrayList();
        values.add(toValue(1, 1, getClock(1, 2)));
        values.add(toValue(2, 1, getClock(1, 2)));
        values.add(toValue(3, 1, getClock(1)));
    ...
    public void testMultipleVersionsOnSingleNode() throws Exception {
        ...
        values.add(toValue(1, 1, getClock(3)));
    ...
    public void testMultipleKeysOnSingleNode() throws Exception {
        List<NodeValue<Integer, String, Integer>> values = Lists.newArrayList();
        values.add(toValue(1, 1, getClock(1)));
        values.add(toValue(1, 2, getClock(1)));
        values.add(toValue(1, 3, getClock(1)));
    ...
    public void testAllEqualWithMultipleVersions() throws Exception {
        ...
        values.add(toValue(1, 1, getClock(3)));
        values.add(toValue(2, 1, getClock(1)));
        values.add(toValue(2, 1, getClock(2)));
        values.add(toValue(2, 1, getClock(3)));
        values.add(toValue(3, 1, getClock(1)));
        values.add(toValue(3, 1, getClock(2)));
        values.add(toValue(3, 1, getClock(3)));
